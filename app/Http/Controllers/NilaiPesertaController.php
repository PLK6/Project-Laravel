    ...
    public function index(Request $request)
{
    ...
    {
        $fasil = Fasilitator::all();//mengambil semua data fasilitator
        $psrt = Peserta::all();//mengambil semua data peserta
        $tahunOptions = NilaiPeserta::distinct('tahun')->pluck('tahun');
        $levelOptions = NilaiPeserta::distinct('level')->pluck('level');

        return view('nilai_peserta.create', compact('tahunOptions', 'levelOptions', 'psrt', 'fasil'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function edit($id)
    {
        ...
        return view('nilai_peserta.edit', compact('nilaiPeserta', 'psrt', 'fasil'));
    }
